...
(function (customUtil) {
    ...
    function GetRotR(self) {
        return self.GetAbsRotation().y * Math.PI / 180;
    }
    function RotatePosition(center, angle, pos) {
        if (center.x == undefined)
            center = center.GetAbsOrigin();
        if (pos.x == undefined)
            pos = pos.GetAbsOrigin();
        let radi = (angle) * (Math.PI / 180);
        let x1 = pos.x - center.x;
        let y1 = pos.y - center.y;
        return new Vector(Math.cos(radi) * x1 - Math.sin(radi) * y1 + center.x, Math.sin(radi) * x1 + Math.cos(radi) * y1 + center.y, center.z);
    }
        ...
        if (gameStarted) {
            if (!Engine.IsShopOpen()) {
                ...
                if (fountainENABLE && actualFountainPoses) {
                    let size = 24 * ration;
                    for (let pos of actualFountainPoses) {
                        if (fountainShowInRadius && !InRadiusByPos(fountainPoses[0]))
                            continue;
                        let [x, y, OnScreen] = Renderer.WorldToScreen(pos);
                        if (!OnScreen)
                            continue;
            ...
            if (spinnerENABLE && spinnerBind.IsKeyDown()) {
                ...
                if (Engine.OnceAtByKey(0.1, 'Spinner')) {
                    myPlayer.PrepareUnitOrdersStructed({
                        orderIssuer: Enum.PlayerOrderIssuer.DOTA_ORDER_ISSUER_HERO_ONLY,
                        position: RotatePosition(me.GetAbsOrigin(), GetRotR(me) + angleForSpinner, me.GetAbsOrigin().add(new Vector(Math.floor(Math.random() * (400 - 350 + 1)) + 350).Rotated(GetRotR(me) + angleForSpinner))),
                    ...
                    angleForSpinner += GetRotateTime(me);
                }
            }
...
/******/ });
//# sourceMappingURL=data:application/json;charset=utf-8;base64,